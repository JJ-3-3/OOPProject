...
double Employee::returnOverallShareValue() { 
    return *shareList[0]->shareValue;
}
void Employee::addShare(Share* addedShare) {
    shareList.push_back(addedShare);
}
  // virtual
...
void Employee::printPayments(){
    ...
    // virtual
string Employee::getWorkTypeName(){
    return workTypeName;
}

void Employee::setClockTimesForDay(int week, int day, int clockIn, int clockOut){
